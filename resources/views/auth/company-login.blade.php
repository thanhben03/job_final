<x-guest-layout>
    ...
    <form method="POST" action="{{ route('company.login.store') }}">
        ...
        <div>
            ...
            <x-text-input id="company_email" class="block mt-1 w-full" type="email" name="company_email" :value="old('company_email')" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="company_password" class="block mt-1 w-full"
                            type="password"
