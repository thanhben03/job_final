...
<div id="chat-bot" class="container py-5 d-none">
        ...
        <div class="row d-flex justify-content-center" style="position: fixed;
                                                            bottom: 122px;
                                                            z-index: 999999;
                                                            right: 60px;
                                                            width: 423px;">
                        ...
                        <div class="wrap-message">
                            <div class="d-flex flex-row justify-content-start mb-4">
                                ...
                                <div class="p-3 ms-3" style="border-radius: 15px; background-color: rgba(57, 192, 237,.2);">
                                    <p class="small mb-0">Hello, how can i help you ?</p>
                                </div>
                            </div>
                        </div>

                        <div data-mdb-input-init class="form-outline">
                            <textarea class="form-control bg-body-tertiary" id="message-to-bot" rows="4"></textarea>
...
<button class="toggle-chat">
    <svg class="close-chat" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
@push('js')
    <script>
        const input = document.getElementById('message-to-bot');


        input.addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {  // Kiểm tra nếu phím là 'Enter'
                const inputValue = input.value;  // Lấy giá trị của ô input
                input.value = ''
