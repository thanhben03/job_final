...
@push('css')
    <style>
        ...
        #overlay {
            ...
            align-items: center;
            z-index: 9999;
            /* Hiển thị trên tất cả các thành phần khác */
            visibility: hidden;
            /* Ẩn overlay mặc định */
        }
...
@section('content')
    ...
    <div class="modal fade" id="modal-show-appointment" tabindex="-1" aria-labelledby="appointmentsModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modal-edit-appoinment" tabindex="-1" aria-labelledby="editAppointmentModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg modal-fullscreen-sm-down">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editAppointmentModalLabel">
                        {{ trans('lang.Changing Appointment Date and Time') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="modal-cancel-appoinment" tabindex="-1" aria-labelledby="editAppointmentModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg modal-fullscreen-sm-down">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <button onclick="cancelAppointment()" type="button"
        ...
        <div class="content-admin-main">
            ...
            <div class="wt-admin-right-page-header clearfix">
                ...
                <div class="breadcrumbs"><a href="#">{{ trans('lang.header.home') }}</a><a
                        href="#">{{ trans('lang.user.dashboard') }}</a><span>{{ trans('lang.Manage Jobs') }}</span>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($careers as $career)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="twm-jobs-category"><span class="twm-bg-green">Part Time</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="twm-jobs-category">
                                                @switch($career['published'])
                                                    ...
                                                    @case(2)
                                                        ...
                                                        <p onclick="viewReason({{ $career['id'] }})"
                                                            style="text-decoration: underline; font-size: 13px">>>Xem lí do<<< /p>
                                                            @break
                                                        @endswitch
                                        ...
                                        <td>
                                            ...
                                            <a onclick="showModalListAppoints({{ json_encode($career['appointments'], 1) }})"
                                                class="site-text-primary" href="#">
                                            ...
                                            <div class="twm-table-controls">
                                                <ul class="twm-DT-controls-icon list-unstyled">
                                                    @if ($career['published'] != 2)
                                                        <li>
                                                            <button
                                                                onclick="matchWithCandidate({{ $career['id'] }}, 'match_cv')"
                                                    ...
                                                    @endif
                                                    <li>
                                                        <button onclick="deleteJob({{ $career['id'] }})" title="Delete"
