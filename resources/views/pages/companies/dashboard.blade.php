                            ...
                            <div class="panel-body wt-panel-body bg-white">
                                <div class="dashboard-messages-box-scroll scrollbar-macosx">
                                    ...
                                    <div class="dashboard-messages-box">
                                        <div class="dashboard-message-avtar"><img src="{{asset('images/user-avtar/pic1.jpg')}}" alt=""></div>
                                    ...
                                    <div class="dashboard-messages-box">
                                        <div class="dashboard-message-avtar"><img src="{{asset('/images/user-avtar/pic3.jpg')}}" alt=""></div>
                                        <div class="dashboard-message-area">
                                    ...
                                    <div class="dashboard-messages-box">
                                        <div class="dashboard-message-avtar"><img src="{{asset('/images/user-avtar/pic4.jpg')}}" alt=""></div>
                                        <div class="dashboard-message-area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-12 col-md-12">
                                            <div class="twm-dash-candidates-list">
                                                <div class="twm-media">
                                                    <div class="twm-media-pic">
                                                        <img src="{{asset('/images/candidates/pic2.jpg')}}" alt="#">
                                                    </div>
                                        ...
                                        <div class="col-xl-6 col-lg-12 col-md-12">
                                            <div class="twm-dash-candidates-list">
                                                <div class="twm-media">
                                                    <div class="twm-media-pic">
                                                        <img src="{{asset('/images/candidates/pic3.jpg')}}" alt="#">
                                                    </div>
                                        ...
                                        <div class="col-xl-6 col-lg-12 col-md-12">
                                            <div class="twm-dash-candidates-list">
                                                <div class="twm-media">
                                                    <div class="twm-media-pic">
                                                        <img src="{{asset('/images/candidates/pic4.jpg')}}" alt="#">
                                                    </div>
                                        ...
                                        <div class="col-xl-6 col-lg-12 col-md-12">
                                            <div class="twm-dash-candidates-list">
                                                <div class="twm-media">
                                                    <div class="twm-media-pic">
                                                        <img src="{{asset('/images/candidates/pic6.jpg')}}" alt="#">
                                                    </div>
