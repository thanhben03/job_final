...
class CareerDetailRepository extends EloquentRepository implements CareerDetailRepositoryInterface
{
    ...
    public function loadRelation(CareerDetail $careerDetail, array $relations = []): CareerDetail
    {
        return $careerDetail->load($relations);
    }
