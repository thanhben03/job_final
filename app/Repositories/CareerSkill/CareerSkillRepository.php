...
class CareerSkillRepository extends EloquentRepository implements CareerSkillRepositoryInterface
{
    ...
    public function loadRelation(CareerSkill $careerSkill, array $relations = []): CareerSkill
    {
        return $careerSkill->load($relations);
    }
